...
const RESULT_SOUL_PROCESSION_FIXED_SLOTS = [
  { dx: 70, dy: -8, displayHeight: 51, alpha: 0.86 },
...
const RESULT_GOD_ICON_SHADOW_WIDTH_RATIO = 0.612;
const RESULT_GOD_ICON_SHADOW_HEIGHT_RATIO = 0.19125;
const RESULT_GOD_ICON_SHADOW_OFFSET_X_RATIO = 0.08;
const RESULT_GOD_ICON_SHADOW_OFFSET_Y = -3.5;
