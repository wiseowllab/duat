...
const GOD_UNLOCK_PRESENTATION_COFFIN_ALPHA = 0.5;
...
const RESULT_SOUL_PROCESSION_SIDE_MIN_RATIO = 0.31;
const RESULT_SOUL_PROCESSION_SIDE_MAX_RATIO = 0.38;
...
const RESULT_GOD_ICON_SHADOW_ALPHA = 0.48;
const RESULT_GOD_ICON_SHADOW_WIDTH_RATIO = 0.96;
const RESULT_GOD_ICON_SHADOW_HEIGHT_RATIO = 0.3;
...
${COMMIT_SHA}`, {
  ...
  createResultSkyBackground(panelWidth, panelHeight) {
    ...
    if (!this.textures.exists(skyAsset.key)) {
