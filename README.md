...
- Result god icons use the same per-god coffin PNGs from `docs/assets/images/coffins/gods/` as v0.1 placeholder statues. Unlocked gods are arranged in gentle arcs near the temple base: bright/full-color icons mean the god's bomb was preserved/unused, while dim gray icons mean that god's bomb was used during the run.
